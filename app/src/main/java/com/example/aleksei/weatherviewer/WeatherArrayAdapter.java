package com.example.aleksei.weatherviewer;
...
public class WeatherArrayAdapter extends ArrayAdapter<Weather> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (bitmapMap.containsKey(day.iconURL)) {
            viewHolder.conditionImageView.setImageBitmap(bitmapMap.get(day.iconURL));
        } else {
